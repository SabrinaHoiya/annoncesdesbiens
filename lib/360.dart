...
class Demo360 extends StatefulWidget {
  Demo360({ key, required this.title}) : super(key: key);
...
class _DemoPageState extends State<Demo360> {
  ...
  void updateImageList(BuildContext context) async {
    for (int i = 1; i <= 52; i++) {
      imageList.add(AssetImage('assets/360/$i.png'));
      //* To precache images so that when required they are loaded faster.
      await precacheImage(AssetImage('assets/360/$i.png'), context);
    }
    setState(() {
      imagePrecached = true;
    });
